...
const menuCategories = [
  {
    id: "yogurt", name: "Yogurt Griego", emoji: "\u{1F963}",
    description: "Nuestro yogurt griego natural con tus toppings favoritos",
    items: [
      { id: "delight-fantasia", name: "Delight Fantasia", description: "Yogurt griego con banano, fresas, chispas de chocolate, cereal crocante y jalea a tu eleccion", price: 2.00, image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-02-17%20at%2011.18.59%20AM-MW8UjXtnRjrKjVH4c0xLtqh1NcpSlK.jpeg", customizable: true, toppings: ["Fresas","Arandanos","Mango","Kiwi","Banano","Granola","Chispas de chocolate","Cereal crocante"] },
      { id: "parfait-griego", name: "Parfait de Yogurt Griego", description: "Yogurt griego 0% grasa con frutos rojos, miel y granola. 145 calorias, 12g proteina", price: 2.50, image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-02-17%20at%2011.18.59%20AM%20%284%29-4UkVEdpIoGAgiCzj74ywRHASTF2pDs.jpeg", customizable: true, toppings: ["Fresas","Arandanos","Mango","Kiwi","Banano","Granola","Miel"] },
    ]
  },
  {
    id: "tostada", name: "Tostada DeLight", emoji: "\u{1F35E}",
    description: "Pan integral con ingredientes frescos y saludables",
    items: [
      { id: "tostada-proteica", name: "Tostada Proteica DeLight", description: "Pan integral al horno con crema ligera de Skyr islandes, coronado con frutas y un toque de miel", price: 2.00, customizable: true, toppings: ["Fresas","Arandanos","Mango","Kiwi","Banano","Granola"] },
      { id: "tostada-pomodoro", name: "Tostada Pomodoro DeLight", description: "Pan integral con Skyr, tomates cherry al pomodoro, albahaca fresca y balsamico", price: 2.00 },
    ]
  },
  {
    id: "wraps", name: "Wraps DeLight", emoji: "\u{1F32F}",
    description: "Wraps frescos y proteicos",
    items: [
      { id: "wrap-delight", name: "Wrap Proteico DeLight", description: "Pollo grillado con lechugas, pepino, tomate cherry y cebolla morada encurtida. Servido con dip de Skyr al limon y eneldo", price: 2.50 },
    ]
  },
  {
    id: "ensaladas", name: "Ensaladas DeLight", emoji: "\u{1F957}",
    description: "Ensaladas frescas y llenas de sabor",
    items: [
      { id: "ensalada-proteica", name: "Ensalada Proteica DeLight", description: "Pollo a la plancha sobre mix de lechugas, tomate cherry, pepino y zanahoria rallada. Con dip de Skyr al limon y hierbas frescas", price: 3.00 },
    ]
  },
  {
    id: "combos", name: "Combos DeLight", emoji: "\u{1F389}",
    ...
    items: [
      ...
      { id: "super-combo", name: "Super Combo Imperdible", description: "Una tostada con queso holandes y jamon + un vaso de yogur natural", price: 1.50, image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-02-17%20at%2011.18.59%20AM%20%283%29-dzCpR9F9BbpMH5qFghpHCl8aJ3JEuS.jpeg" },
    ]
  },
  {
    id: "bebidas", name: "Bebidas DeLight", emoji: "\u{1F964}",
    description: "Refrescantes y naturales",
    items: [
      { id: "limonada-tropical", name: "Limonada Tropical", description: "Mango + Pina", price: 1.30 },
      { id: "limonada-frutos-rojos", name: "Limonada de Frutos Rojos", description: "Limonada natural con frutos rojos", price: 1.50 },
      { id: "maracuya-hierbabuena", name: "Maracuya & Hierbabuena", description: "Refrescante mezcla de maracuya con hierbabuena", price: 1.50 },
      { id: "te-verde-menta", name: "Te Verde Menta & Limon", description: "Te verde con menta fresca y limon", price: 1.50 },
      { id: "te-hibisco", name: "Te de Hibisco Frio", description: "Te de hibisco frio y refrescante", price: 1.50 },
      { id: "smoothie-verde", name: "Smoothie Verde Vital", description: "Espinaca + manzana + pepino", price: 1.75 },
      { id: "smoothie-cacao", name: "Smoothie Cacao & Banana", description: "Smoothie de cacao con banana", price: 2.50 },
      { id: "agua", name: "Agua", description: "Agua natural", price: 0.50 },
    ]
  }
];

const specialtiesData = [
  { title: "Delight Fantasia", description: "Yogurt griego con banano, fresas, chispas de chocolate, cereal crocante y jalea", price: "$2.00", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-02-17%20at%2011.18.59%20AM-MW8UjXtnRjrKjVH4c0xLtqh1NcpSlK.jpeg" },
  { title: "Parfait de Yogurt Griego", description: "Yogurt griego 0% grasa, frutos rojos, miel y granola. Solo 145 calorias", price: "$2.50", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-02-17%20at%2011.18.59%20AM%20%284%29-4UkVEdpIoGAgiCzj74ywRHASTF2pDs.jpeg" },
  { title: "Super Combo Imperdible", description: "Tostada con queso holandes y jamon + vaso de yogur natural", price: "$1.50", image: "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/WhatsApp%20Image%202026-02-17%20at%2011.18.59%20AM%20%283%29-dzCpR9F9BbpMH5qFghpHCl8aJ3JEuS.jpeg" },
];
...
function renderMenu() {
  ...
  cats.forEach(function(cat) {
    ...
    cat.items.forEach(function(item, idx) {
      ...
      if (item.customizable && item.toppings) {
      ...
      const btnLabel = item.customizable ? "Personalizar" : "Agregar";
      html += '<button class="add-btn" onclick="handleAddClick(\'' + item.id + '\', ' + item.customizable + ')">';
...
function getSelectedToppings(itemId) {
  const toppings = [];
  document.querySelectorAll('[data-item="' + itemId + '"].selected').forEach(function(btn) {
    toppings.push(btn.dataset.topping);
  });
  return toppings;
}

function handleAddClick(itemId, customizable) {
...
function addToCart(item, toppings) {
  ...
  if (existing) {
    ...
    cartItems.push({ id: cartId, name: item.name, price: item.price, quantity: 1, toppings: toppings });
  }
...
function getTotal() {
  return cartItems.reduce(function(s, i) { return s + i.price * i.quantity; }, 0);
}
...
function renderCart() {
  ...
  html += '<svg style="width:1rem;height:1rem;" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg> Domicilio</button>';
  html += '</div></div>';
...
function sendToWhatsApp() {
  ...
  if (deliveryType === "pickup" && pickupTime) msg += "*Hora de retiro:* " + pickupTime + "\n";
  if (deliveryType === "delivery" && address) msg += "*Direccion:* " + address + "\n";
  msg += "\n*--- Detalle del pedido ---*\n\n";
  cartItems.forEach(function(item) {
    msg += item.quantity + "x " + item.name + " - $" + (item.price * item.quantity).toFixed(2) + "\n";
    if (item.toppings && item.toppings.length > 0) msg += "   Toppings: " + item.toppings.join(", ") + "\n";
  });
